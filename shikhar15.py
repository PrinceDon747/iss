...
| $$      | $$      | $$| $$  | $$ \$$     \ \$$     \
 ...
 Status    {M}:\033[1;32m paid {P}
 Version   {M}: {Crazy}2.6\033[1;37m
{warna}---------------------------------------------------{P}""")
led = f"""{warna}---------------------------------------------------"""
#---------------------[LOOP MENU]---------------------#
...
if 'START' in ck:
    ...
    exit(f'{K}Updating Crazy Green Fire');os.system("xdg-open https://github.com/SHIKHAR15");os.system("xdg-open https://www.facebook.com/Brand thaquree.TOH.SONSO?mibextid=ZbWKwL")
elif 'BYS' in ck:
